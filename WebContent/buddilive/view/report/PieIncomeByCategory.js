Ext.define('BuddiLive.view.report.PieIncomeByCategory', {
	"extend": "Ext.panel.Panel",
	"alias": "widget.reportpieincomebycategory",
	
	"requires": [
		"BuddiLive.store.report.PieIncomeByCategoryStore"
	],
	...
	"initComponent": function(){
		...
		this.items = [
			{
				"xtype": "chart",
				"store": Ext.create("BuddiLive.store.report.PieIncomeByCategoryStore"),
				"series": [{
					"type": "pie",
					"angleField": "amount",
					"showInLegend": true,
