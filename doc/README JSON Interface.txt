...
echo "[{'name': 'Bank Account 1', 'type':'D', 'startBalance': 12345},{'name': 'Credit Card', 'type': 'C'},{'name':'Groceries','type':'E'},{'name':'Salary','type':'I', 'parent': 2}]" | curl -d @- -u "foo@example.com:password" "http://localhost:8080/data/sources/" | jsonlint; echo ""
