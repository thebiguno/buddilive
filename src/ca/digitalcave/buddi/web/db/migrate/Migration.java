package ca.digitalcave.buddi.web.db.migrate;
...
public class Migration {
	...
	public static void migrate(SqlSessionFactory sqlSessionFactory, String schema) throws Exception {
		...
		try {
			...
			final Liquibase liquibase = new Liquibase("ca/digitalcave/buddi/web/db/migrate/master.xml", new ClassLoaderResourceAccessor(), new JdbcConnection(conn));
